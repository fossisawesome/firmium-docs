...
Open the lyrics panel from the player bar to view the lyrics for the current track. If your server provides synced lyrics, Firmium shows them karaoke-style, highlighting the current line as the song plays. Otherwise, you'll see plain, unsynced lyrics.
